...
export const PrevButton = ({ onClick, disabled }: { onClick: () => void; disabled: boolean }) => {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className='w-8 h-8 bg-accent text-white flex items-center justify-center shadow-sm disabled:opacity-70 '
    >
      <FaArrowLeft />
    </button>
  )
...
export const NextButton = ({ onClick, disabled }: { onClick: () => void; disabled: boolean }) => {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className='w-8 h-8 bg-black text-white flex items-center justify-center shadow-sm disabled:opacity-70 '
    >
      <FaArrowRight />
    </button>
  )
